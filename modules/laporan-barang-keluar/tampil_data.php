...
if (basename($_SERVER['PHP_SELF']) === basename(__FILE__)) {
    ...
    // --- 1. DATA DUMMY (Diperkaya untuk Modal) ---
    $data_laporan = [
        [
            'id_transaksi' => 'TRX-2025-001',
            'divisi'       => 'Sekretariat Perusahaan (DSPN)',
            'kode_divisi'  => 'DSPN',
            'dokumen_utama'=> 'SK Direksi Pengangkatan', // Untuk tampilan tabel
            'rf_id'        => 'RF-DSPN-01',
            'jml_bantex'   => 2,
            'jml_box'      => 1,
            'status'       => 'Terkirim',
        ...
        [
            ...
            'status'       => 'Selesai',
            'history'      => [
                ['status' => 'Box Telah Selesai', 'date' => '2025-01-19 16:00', 'user' => 'Admin Arsip', 'color' => 'success'],
                ['status' => 'Box Telah di Kirim', 'date' => '2025-01-19 12:00', 'user' => 'Kurir', 'color' => 'primary']
            ]
        ],
        [
    ...
    foreach($data_laporan as $row) {
        if($selected_divisi == '' || $row['kode_divisi'] == $selected_divisi) {
            $data_tampil[] = $row;
            // Simulasi hitung total dokumen (misal 1 baris = 5 dokumen)
            $total_dokumen += 5; 
                        ...
                        if(empty($data_tampil)) {
                            ...
                            foreach($data_tampil as $row) {
                                ...
                                switch($row['status']) {
                                    ...
                                    case 'Selesai': $stClass = 'st-selesai'; $stDesc = 'Box Telah Selesai'; break;
                                }
