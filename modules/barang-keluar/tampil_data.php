                                ...
                                <tr>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="small text-muted"><i class="far fa-calendar-alt mr-1"></i>
                                                    <?php echo date('d M Y', strtotime($data['tanggal'])); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="badge badge-light border px-3 py-2">
                                            ...
                                            <i class="fas fa-folder text-primary mr-1"></i> <?php echo $data['jumlah']; ?>
                                            Bantex
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center" style="gap: 8px;">
                                            ...
                                            <?php if ($data['status'] == 'Diterima') { ?>
                                                ...
                                                <a href="?module=form_input_dokumen&id=<?php echo $data['id_transaksi']; ?>"
                                                    ...
                                                    data-toggle="tooltip" title="Input Dokumen">
                                            ...
                                            <?php } elseif ($data['status'] == 'Pending') { ?>
                                                ...
                                                <a href="#"
                                                    ...
                                                    class="btn btn-soft-danger btn-round btn-sm font-weight-bold px-3"
                                                    data-toggle="tooltip" title="Hapus Pengajuan">
                ...
                <div class="modal-body modal-body-elegant">
                    ...
                    <div id="view-divisi" class="view-section active">
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="card-stat-modern theme-orange">
                                    <div class="icon-circle-modern">
                                        <div class="dashed-border"><i class="fas fa-clock"></i></div>
                                    </div>
                        ...
                        <div class="text-center mt-4">
                            <p class="text-muted small"><i class="fas fa-mouse-pointer mr-1"></i> Klik kartu <b>Total
                                    Box</b> untuk melihat rincian.</p>
                        </div>
                    </div>
                    ...
                    <div id="view-dokumen" class="view-section">
                        <div class="d-flex align-items-center mb-4"><button
                                class="btn btn-sm btn-icon btn-light rounded-circle mr-3" onclick="backToBantex()"><i
                                    class="fas fa-arrow-left"></i></button>
