                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="divisi" class="form-control" value="<?php echo $divisi_lama; ?>"
                                    required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal" class="form-control" value="<?php echo $tanggal_lama; ?>"
                                    required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" id="jumlah_bantex" name="jumlah_bantex" class="form-control"
                                    value="<?php echo $bantex_lama; ?>" min="1" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Total Box (Otomatis) <span class="text-danger">*</span></label>
                                <input type="number" id="total_box" name="total_box" class="form-control"
                                    value="<?php echo $box_lama; ?>" readonly style="background-color: #f5f5f5;">
