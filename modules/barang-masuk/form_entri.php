        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="text-right">
                        <div class="small text-muted">Total Bantex: <span class="font-weight-bold text-primary"
                                id="countBantex">0</span></div>
                        <div class="small text-muted">Total Box: <span class="font-weight-bold text-success"
                                id="countBox">0</span></div>
                    </div>
                </div>
                ...
                <button type="button" id="btnShowForm" class="btn btn-primary btn-block font-weight-bold py-2 mb-4"
                    onclick="showInlineForm()">
                ...
                <div id="formInlineBantex" class="form-section mb-4 shadow-sm" style="display: none;">
                    ...
                    <div class="bg-white border rounded p-3 mb-3">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <label class="mb-0 font-weight-bold text-muted">Dokumen dalam Bantex <span
                        ...
                        <div class="row mb-2 px-2 text-muted font-weight-bold"
                ...
                <div class="border-top pt-4 row">
                    <div class="col-md-6 mb-2">
                        <button type="button" onclick="handlePreSubmit()"
                            class="btn btn-success btn-block btn-lg font-weight-bold shadow">
            ...
            <div class="card-footer bg-blue-50" style="background-color: #e1f5fe;">
                <div class="d-flex align-items-start text-info">
                    ...
                    <small><strong>Informasi:</strong> Setiap kotak dapat menampung hingga 6 bantex. Sistem akan secara
                        otomatis membuat kotak baru ketika jumlah bantex mencapai 6.</small>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body p-4 bg-light">
                    ...
                    <div class="bg-white p-3 rounded shadow-sm mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <small class="text-muted d-block font-weight-bold text-uppercase"
                                    style="font-size: 10px;">Lokasi Arsip</small>
                                <span class="font-weight-bold text-dark" id="confLokasi">-</span>
                            </div>
                            <div class="col-md-6 mb-2">
                                <small class="text-muted d-block font-weight-bold text-uppercase"
                                    style="font-size: 10px;">Tanggal Pengajuan</small>
                                <span class="font-weight-bold text-dark"><?= date('Y-m-d') ?></span>
                            </div>
                            <div class="col-md-6 mb-2">
                                <small class="text-muted d-block font-weight-bold text-uppercase"
                                    style="font-size: 10px;">Total Bantex</small>
